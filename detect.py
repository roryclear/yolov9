...
class RepNCSPELAN4():
    # csp-elan
    def __init__(self, in_ch=1, out_ch=1, in_ch2=1, ch4=1,\
        ...
        self.cv2[0] = RepNCSP(in_ch2, ch4, in_ch2, ch4, n)
        ...
        self.cv3[0] = RepNCSP(in_ch2, ch4, in_ch2, ch4, n)
...
if __name__ == "__main__":
  for size in ["t", "s", "m", "c", "e"]:
    ...
    if size == "t":
      ...
      model.model[18] = RepNCSPELAN4(144, 96, 48, 24, 192, 96)
      ...
      model.model[21] = RepNCSPELAN4(192, 128, 64, 32, 256, 128)
      ...
      model.model[2] = RepNCSPELAN4(128, 128, 32*2, 16*2, 256, 256, n=1)
      model.model[3] = ADown()
      model.model[4] = RepNCSPELAN4(256, 256, 128, 64, 512, 512, n=1)
      model.model[5] = ADown(ch0=256)
      model.model[6] = RepNCSPELAN4(512, 512, 256, 128, 1024, 512, n=1)
      model.model[7] = ADown(ch0=256)
      model.model[8] = RepNCSPELAN4(512, 512, 256, 128, 1024, 512, n=1)
      model.model[9] = SPPELAN(ch0=512, ch1=256, ch2=1024, ch3=512)
      model.model[10] = Upsample()
      model.model[11] = Concat(f=[-1, 6])
      model.model[12] = RepNCSPELAN4(1024, 512, 256, 128, 1024, 512, n=1)
      model.model[13] = Upsample()
      model.model[14] = Concat(f=[-1, 4])
      model.model[15] = RepNCSPELAN4(1024, 256, 128, 64, 512, 256, n=1)
      model.model[16] = ADown(ch0=128)
      model.model[17] = Concat(f=[-1, 12])
      model.model[18] = RepNCSPELAN4(768, 512, 256, 128, 1024, 512, n=1)
      model.model[19] = ADown(ch0=256)
      model.model[20] = Concat(f=[-1, 9])
      model.model[21] = RepNCSPELAN4(1024, 512, 256, 128, 1024, 512, n=1)
      ...
      model.model[3] = RepNCSPELAN4(128, 128, 32*2, 16*2, 256, 256, n=2)
      model.model[4] = ADown(ch0=128)
      model.model[5] = RepNCSPELAN4(256, 256, 128, 64, 512, 512, n=2)
      model.model[6] = ADown(ch0=256)
      model.model[7] = RepNCSPELAN4(512, 512, 256, 128, 1024, 1024, n=2)
      model.model[8] = ADown(ch0=512)
      model.model[9] = RepNCSPELAN4(1024, 512, 256, 128, 1024, 1024, n=2)
