...
class RepNCSPELAN4():
    # csp-elan
    def __init__(self, in_ch=1, out_ch=1, in_ch2=1, out_ch2=1, ch3=1, ch4=1,\
        ...
        self.cv2[1] = Conv(in_channels=ch3, out_channels=ch3, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), dilation=(1, 1))
...
if __name__ == "__main__":
  for size in ["t", "s", "m", "c", "e"]:
    ...
    if size == "t":
      ...
      model.model[18] = RepNCSPELAN4(144, 96, 48, 24, 48, 24, 192, 96)
      ...
      model.model[21] = RepNCSPELAN4(192, 128, 64, 32, 64, 32, 256, 128)
      ...
      model.model[2] = RepNCSPELAN4(128, 128, 32*2, 16*2, 32*2, 16*2, 256, 256, n=1)
      model.model[3] = ADown()
      model.model[4] = RepNCSPELAN4(256, 256, 128, 64, 128, 64, 512, 512, n=1)
      model.model[5] = ADown(ch0=256)
      model.model[6] = RepNCSPELAN4(512, 512, 256, 128, 256, 128, 1024, 512, n=1)
      model.model[7] = ADown(ch0=256)
      model.model[8] = RepNCSPELAN4(512, 512, 256, 128, 256, 128, 1024, 512, n=1)
      model.model[9] = SPPELAN(ch0=512, ch1=256, ch2=1024, ch3=512)
      model.model[10] = Upsample()
      model.model[11] = Concat(f=[-1, 6])
      model.model[12] = RepNCSPELAN4(1024, 512, 256, 128, 256, 128, 1024, 512, n=1)
      model.model[13] = Upsample()
      model.model[14] = Concat(f=[-1, 4])
      model.model[15] = RepNCSPELAN4(1024, 256, 128, 64, 128, 64, 512, 256, n=1)
      model.model[16] = ADown(ch0=128)
      model.model[17] = Concat(f=[-1, 12])
      model.model[18] = RepNCSPELAN4(768, 512, 256, 128, 256, 128, 1024, 512, n=1)
      model.model[19] = ADown(ch0=256)
      model.model[20] = Concat(f=[-1, 9])
      model.model[21] = RepNCSPELAN4(1024, 512, 256, 128, 256, 128, 1024, 512, n=1)
      ...
      model.model[3] = RepNCSPELAN4(128, 128, 32*2, 16*2, 32*2, 16*2, 256, 256, n=2)
      model.model[4] = ADown(ch0=128)
      model.model[5] = RepNCSPELAN4(256, 256, 128, 64, 128, 64, 512, 512, n=2)
      model.model[6] = ADown(ch0=256)
      model.model[7] = RepNCSPELAN4(512, 512, 256, 128, 256, 128, 1024, 1024, n=2)
      model.model[8] = ADown(ch0=512)
      model.model[9] = RepNCSPELAN4(1024, 512, 256, 128, 256, 128, 1024, 1024, n=2)
      ...
      model.model[19] = RepNCSPELAN4(128, 128, 64, 32, 64, 32, 256, 256, n=2)
      model.model[20] = ADown(ch0=128)
      model.model[21] = CBFuse(f=[12, 13, 14, -1], idx=[2, 2, 2])
      model.model[22] = RepNCSPELAN4(256, 256, 128, 64, 128, 64, 512, 512, n=2)
      model.model[23] = ADown(ch0=256)
      model.model[24] = CBFuse(f=[13, 14, -1], idx=[3, 3])
      model.model[25] = RepNCSPELAN4(512, 512, 256, 128, 256, 128, 1024, 1024, n=2)
      model.model[26] = ADown(ch0=512)
      model.model[27] = CBFuse(f=[14, -1], idx=[4])
      model.model[28] = RepNCSPELAN4(1024, 512, 256, 128, 256, 128, 1024, 1024, n=2)
      model.model[29] = SPPELAN(ch0=1024, ch1=256, ch2=1024, ch3=512, f=28)
      model.model[30] = Upsample()
      model.model[31] = Concat(f=[-1, 25])
      model.model[32] = RepNCSPELAN4(1536, 512, 256, 128, 256, 128, 1024, 512, n=2)
      model.model[33] = Upsample()
      model.model[34] = Concat(f=[-1, 22])
      model.model[35] = RepNCSPELAN4(1024, 256, 128, 64, 128, 64, 512, 256, n=2)
      model.model[36] = ADown(ch0=128)
      model.model[37] = Concat(f=[-1, 32]) 
      model.model[38] = RepNCSPELAN4(768, 512, 256, 128, 256, 128, 1024, 512, n=2)
      model.model[39] = ADown(ch0=256)
      model.model[40] = Concat(f=[-1, 29])
      model.model[41] = RepNCSPELAN4(1024, 1024, 512, 256, 512, 256, 2048, 512, n=2)
